...
function animateJumps () {
    ...
    mainJumpLeft.addAnimationFrame(assets.image`myImage`)
    mainJumpLeft.addAnimationFrame(assets.image`myImage`)
    ...
    mainJumpRight.addAnimationFrame(assets.image`myImage`)
    mainJumpRight.addAnimationFrame(assets.image`myImage`)
    for (let index = 0; index < 30; index++) {
        mainJumpRight.addAnimationFrame(assets.image`myImage`)
    }
